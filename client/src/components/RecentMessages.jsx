  ...
  const fetchRecentMsgs = async () => {
    try {
      ...
      if (data.success) {
        ...
        //sort msgs by date
        const sortMsgs = Object.values(grpMsg).sort(
      ...
      <div className="msg-box">
        {msgs.map((msg) => {
          const unseenCount = allMsgs.filter(
            (m) => m.sender_id?._id === msg.sender_id?._id && !m.seen
          ).length;
          return (
            <Link
              key={msg._id}
            ...
            >
              ...
              <div className="w-full">
                ...
                <div className="flex justify-between">
                  ...
                  {unseenCount > 0 && (
                    <p className="bg-[#ECC154] text-gray-950 w-4 h-4 flex items-center justify-center rounded-full text-[10px]">
                      {unseenCount}
                    </p>
                  )}
                </div>
